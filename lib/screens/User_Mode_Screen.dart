...
import 'welcome_screen_booking.dart'; // Ensure this matches your filename
...
class _UserModeScreenState extends State<UserModeScreen> {
  ...
  void _handleContinue() async {
    ...
    if (selectedMode == "Passenger") {
      // Navigates to the Welcome Screen for Booking
      Navigator.push(
          context,
          createSmoothRoute(WelcomeScreenBooking(language: widget.language))
      );
  ...
  Widget build(BuildContext context) {
    ...
    String subtitle = widget.language == "Urdu" ? "آپ گو لاہور کو کیسے استعمال کرنا چاہیں گے؟" : "How would you like to use GoLahore?";
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: isLoading
                          ...
                          : Text(continueBtn, style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.black, fontSize: 16, letterSpacing: 1.2)),
                    ),
                  ),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Icon(isSelected ? Icons.radio_button_checked : Icons.radio_button_off, color: isSelected ? Colors.orangeAccent : Colors.white24, size: 26),
          ],
        ),
      ),
    );
